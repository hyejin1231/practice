...
<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   try{
      ...
      pstmt.setString(1,request.getParameter("uesrname"));
      pstmt.setString(2,request.getParameter("email"));

      // username 값을 입력한 경우 sql 문장을 수행.
      if(request.getParameter("uesrname") != null) {
         pstmt.executeUpdate();
      }
   }
   catch(Exception e) {
...
<form name=form1 method=post action=jdbctest2.jsp>
등록이름 : <input type=text name=uesrname>
